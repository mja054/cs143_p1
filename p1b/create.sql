...
CREATE TABLE IF NOT EXISTS MovieGenre (mid int PRIMARY KEY, genre varchar(20));
CREATE TABLE IF NOT EXISTS MovieDirector (mid int PRIMARY KEY, did int);
CREATE TABLE IF NOT EXISTS MovieActor (mid int PRIMARY KEY, aid int, role varchar(50));
